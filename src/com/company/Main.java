...
public class Main {
    ...
    public static String[] heroesType = {"Warrior","Magician","Telepath","Golem","Ninja"};
    ...
    public static int[] heroesHealth = {270,280,260,750,175};
    public static int[] heroesDamage = {20,15,25,5,15};
    public static String[] newHeroes  = {heroesType [3] , heroesType[4]};
    public static int[] newHeroesHealth = {heroesHealth[3] , heroesHealth[4]};

    public static String[] heroesAttackType = {"Physical","Magical","Kinetic","Physical","Magical"};
    ...
    public static void printDStatistics() {
        ...
        for (int i = 0; i < heroesHealth.length ; i++) {
            System.out.println(heroesType[i]+" health: "+ heroesHealth[i]+" ["+ heroesDamage[i]+ "]" );
        }
        System.out.println();
    }
